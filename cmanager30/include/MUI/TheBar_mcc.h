...
/*
**  $VER: TheBar_mcc.h 19.0 (10.1.2005)
**  Includes Release 19.0
**
...
#define THEBAR_VERSION     19
#define THEBARVIRT_VERSION 19
#define THEBUTTON_VERSION  19
...
struct MUIS_TheBar_Appareance
{
    ULONG viewMode;
    ULONG flags;
    ULONG dummy[4]; /* Avoid ricompilation */
};
...
enum
{
    ...
    MUIV_TheBar_Appareance_EnableKeys = 1<<4,
    MUIV_TheBar_Appareance_BarSpacer  = 1<<5,
};
