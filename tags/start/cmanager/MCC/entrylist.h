/***************************************************************************
    revision             : $Id: entrylist.h,v 1.1.1.1 2003-01-06 15:59:09 tellini Exp $
...
#define MUIA_EntryList_CMObj        (TAGBASE + 3)
#define MUIA_EntryList_NoMenu       (TAGBASE + 4)
...
#define MUIA_EditWindow_CMObj       (TAGBASE + 16)
#define MUIA_EditWindow_IsEditWin   (TAGBASE + 200)
///
/// Structs
#ifndef ORDERPREFS
struct OrderPrefs {
...
extern void CloseAllEditWindows( Object *AppObj );
///
